...
- **Event Detail Page**  
As a **user** I want the **checkout system to stop me from purchasing more tickets than the event’s available capacity** so that I **cannot buy a ticket to an oversold event with a clear message so that I clearly understand why my order cannot proceed**.  
...
- **Merch Listings**  
*(No user stories currently assigned.)*  

- **Merch Detail Page**  
*(No user stories currently assigned.)*  

- **Ticket Availability Tracking**  
*(No user stories currently assigned beyond the oversell prevention stories above.)*  
...
### 2.4.1.6 Webhooks & Integrations Epic  
...
- **Order Status Update via Square Webhook**  
